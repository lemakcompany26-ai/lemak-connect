...
useEffect(()=>{
  ...
  meta.content = "Buy cheapest MTN, Airtel, Glo, 9mobile data, airtime VTU, pay NEPA, DSTV, GOTV instantly. Fast, secure & automated. Best prices in Nigeria.";
},[]);
return (
<div className="min-h-screen bg-white font-sans">
  ...
  <section className="text-center px-6 py-16 md:py-24 bg-gradient-to-b from-blue-50 to-white">
    ...
    <div className="mt-8 flex justify-center gap-4">
      ...
      <a href="#services" className="px-8 py-4 bg-white border rounded-full font-bold">View Prices</a>
    </div>
  </section>
  ...
  <footer className="text-center py-10 text-sm text-gray-500 border-t"><div className="font-black text-black">LEMAK CONNECT - www.lemakconnect.com</div><div className="mt-2">© 2026 Lemak Connect, Osogbo. Cheap Data & Bills Payment</div></footer>
</div>
)}
