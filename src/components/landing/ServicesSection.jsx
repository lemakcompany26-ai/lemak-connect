...
export const ALL_SERVICES = [
  ...
  { slug: 'electricity', name: 'Electricity', icon: Lightbulb, desc: 'Prepaid & postpaid tokens for major discos.', live: true },
  ...
  { slug: 'education', name: 'Education', icon: GraduationCap, desc: 'WAEC, JAMB & NECO result-checker pins.', live: true },
  { slug: 'epin', name: 'ePIN / Recharge', icon: Ticket, desc: 'Digital recharge pins, delivered instantly.', live: true },
  { slug: 'broadband', name: 'Broadband', icon: Globe, desc: 'Home & office internet subscriptions.', live: true },
